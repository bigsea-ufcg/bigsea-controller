...
from service.api.controller.plugins.fuzzy.fuzzy_alarm import Fuzzy_Alarm
from service.exceptions.monasca_exceptions import No_Metrics_Exception

class Fuzzy_Controller(Controller):
    ...
    def __init__(self, application_id, parameters):
        ...
        self.alarm = Fuzzy_Alarm(actuator, metric_source, self.trigger_down, self.trigger_up,
                                 self.min_cap, self.max_cap, self.metric_rounding, None, 
